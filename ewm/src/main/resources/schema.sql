...
(
    ...
    name        VARCHAR(255)                            NOT NULL,
    CONSTRAINT pk_user PRIMARY KEY (category_id)
);

CREATE TABLE IF NOT EXISTS locations
(
    location_id  BIGINT NOT NULL,
    FOREIGN KEY (location_id) REFERENCES events (location_id) ON DELETE CASCADE,
...
(
    ...
    CONSTRAINT pk_user PRIMARY KEY (event_id)
);
